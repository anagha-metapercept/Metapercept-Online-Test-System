			...
			<div id = "main_container">			
					<div id = "sub_container">
						...
						<?php 
							 ...
							 echo '<tr><td style = "font-weight:bold;">Test Category : '.$result["test_category"].'</td>';
							 echo '<tr>
							 <th>Question No. </th>
							 <th>Question </th>
							...
							$sql2="SELECT test_category_id, question_no, question, correct_ans, marks, question_type from questions where test_category_id = '".$_GET["test_category_id"]."' LIMIT $start, $limit ";
							...
							//simple pagination
							$sql = "SELECT COUNT(question_no) FROM questions";  
...
$(document).ready(function(){
    ...
    var test_category_id = '<?php echo htmlentities($_GET['test_category_id']); ?>';

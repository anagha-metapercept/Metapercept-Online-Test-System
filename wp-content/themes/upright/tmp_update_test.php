			...
			<div id = "main_container">
					<div id = "sub_container">
						...
						echo '<table id = "display_table_data">
							...
							<td class = "use_address"><i class="fa fa-pencil-square" aria-hidden="true"></i></td>
							<td class = "manage_questions"><i class="fa fa-question" aria-hidden="true"></i></td>
							</tr>';
							}
							echo "</table>";
...
<!--Function to manage questions-->
		
<script type="text/javascript">

$(document).ready(function(){
	$(".manage_questions").click(function() { 
    var test_category_id = $(this).closest("tr")   // Finds the closest row <tr> 
                       .find(".nr")     // Gets a descendent with class="nr"
                       .text();        // Retrieves the text within <td>

    window.location = 'http://localhost/wordpress_onlinetest/manage-questions-dashboard?test_category_id='+test_category_id;
    });
});
</script>

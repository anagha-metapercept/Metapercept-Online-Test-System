			...
			<div id = "main_container">
				<div id = "sub_container">
				  ...
				  //code to get test category name
 					$sql_test="SELECT test_category from test_category where test_category_id = '". $_SESSION['test_category_id'] . "'";
				  ...
				  $sql_stud="SELECT fname, lname from student where student_id = '". $_SESSION['student_id'] . "'";
					...
					while($result_stud=mysqli_fetch_array($rs_stud)) {
               		...
               		//code to get result
                  $sql_res="SELECT * FROM result where test_category_id = '".$_SESSION['test_category_id']."' and student_id='".$student_id."'";
                  ...
                  while ($row_res = mysqli_fetch_array($result_res))
                  {
                    ...
                    <tr>
							...
							<tr>
								...
								<td><input type = "text" name = "marks" id="marks" class = "input_buttons1" readonly = "readonly" value = "<?php echo $marks; ?>"></td>
							</tr>	
							<tr>

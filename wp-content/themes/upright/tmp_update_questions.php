...
$sql="SELECT question_no, test_category_id, question,opt1,opt2, opt3, opt4, correct_ans, marks, question_type from questions where question_no = '". $_GET['question_no'] . "'";
...
if(isset($_POST[save])) {
		...
		$rs="UPDATE questions SET  test_category_id = '$test_category_id', question = '$question', opt1 = '$opt1', opt2 = '$opt2', opt3 = '$opt3', opt4 = '$opt4', correct_ans = '$correct_ans', marks = '$marks', question_type = '$question_type' WHERE question_no = '$question_no'";

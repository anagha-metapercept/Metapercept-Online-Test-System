    ...
    <div id = "main_container">
      <div id = "sub_container">
                ...
                //$id = $_GET['test_category_id'];
                 $sql = "SELECT COUNT(question_no) FROM questions where test_category_id =".$_SESSION['test_category_id'];  
              ...
              if (mysqli_num_rows($rs_result)== 0){
                echo "No Questions for Test.";
                  ...
                  $sr_no = 1;
                  $sql1="SELECT * FROM questions where test_category_id = '".$_SESSION['test_category_id']."' LIMIT 0,1"; /*order by RAND() LIMIT 1 OFFSET $a";*/
...
$(document).ready(function(){ alert(id);

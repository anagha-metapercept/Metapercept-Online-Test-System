...
if(isset($_POST[save])) {
		...
		$rs="insert into questions (test_category_id, question, opt1, opt2, opt3, opt4, correct_ans, marks, question_type)
			values('$test_category_id','$question','$opt1','$opt2','$opt3','$opt4','$correct_answer','$marks','$question_type')";
					...
					<tr>
						...
						<tr>
							...
							<tr>
								...
								<td id = "dropdown" name = "correct_ans"><select id = "correct_answer" name = "correct_ans">
							...
							<tr>
								...
								<td id = "drp_quest_type" name = "question_type"><select id = "quest_type" name = "question_type">
